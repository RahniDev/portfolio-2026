...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ma,depthTest:!1,depthWrite:!1})}function _b(o,e,i){const r=new Float32Array(Rr),l=new J(0,1,0);return new Vi({name:"SphericalGaussianBlur",defines:{n:Rr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:kc(),fragmentShader:`
...
#define LOW_PRECISION`),e}const NT={[Uc]:"SHADOWMAP_TYPE_PCF",[Go]:"SHADOWMAP_TYPE_VSM"};function OT(o){return NT[o.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const PT={[Ur]:"ENVMAP_TYPE_CUBE",[Ls]:"ENVMAP_TYPE_CUBE",[Vc]:"ENVMAP_TYPE_CUBE_UV"};function zT(o){return o.envMap===!1?"ENVMAP_TYPE_CUBE":PT[o.envMapMode]||"ENVMAP_TYPE_CUBE"}const FT={[Ls]:"ENVMAP_MODE_REFRACTION"};function BT(o){return o.envMap===!1?"ENVMAP_MODE_REFLECTION":FT[o.envMapMode]||"ENVMAP_MODE_REFLECTION"}const IT={[k_]:"ENVMAP_BLENDING_MULTIPLY",[RM]:"ENVMAP_BLENDING_MIX",[CM]:"ENVMAP_BLENDING_ADD"};function HT(o){return o.envMap===!1?"ENVMAP_BLENDING_NONE":IT[o.combine]||"ENVMAP_BLENDING_NONE"}function GT(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function VT(o,e,i,r){const l=o.getContext(),u=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=OT(i),p=zT(i),v=BT(i),_=HT(i),S=GT(i),E=TT(i),R=AT(u),C=l.createProgram();let y,x,D=i.glslVersion?"#version "+i.glslVersion+`
